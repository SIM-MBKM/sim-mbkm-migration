    ...
    */
    ...
    'connections' => [
        ...
        'registration_management' => [
            'driver' => 'pgsql',
            'url' => env('DB_URL_REGISTRATION_MANAGEMENT_SERVICE'),
            'host' => env('DB_HOST_REGISTRATION_MANAGEMENT_SERVICE', '127.0.0.1'),
            'port' => env('DB_PORT_REGISTRATION_MANAGEMENT_SERVICE', '5432'),
            'database' => env('DB_DATABASE_REGISTRATION_MANAGEMENT_SERVICE', 'laravel'),
            'username' => env('DB_USERNAME_REGISTRATION_MANAGEMENT_SERVICE', 'root'),
            'password' => env('DB_PASSWORD_REGISTRATION_MANAGEMENT_SERVICE', ''),
            'charset' => env('DB_CHARSET', 'utf8'),
            'prefix' => '',
            'prefix_indexes' => true,
            'search_path' => 'public',
        ...
        'matching_management' => [
            'driver' => 'pgsql',
            'url' => env('DB_URL_MATCHING_MANAGEMENT_SERVICE'),
            'host' => env('DB_HOST_MATCHING_MANAGEMENT_SERVICE', '127.0.0.1'),
            'port' => env('DB_PORT_MATCHING_MANAGEMENT_SERVICE', '5432'),
            'database' => env('DB_DATABASE_MATCHING_MANAGEMENT_SERVICE', default: 'laravel'),
            'username' => env('DB_USERNAME_MATCHING_MANAGEMENT_SERVICE', 'root'),
            'password' => env('DB_PASSWORD_MATCHING_MANAGEMENT_SERVICE', ''),
            'charset' => env('DB_CHARSET', 'utf8'),
            'prefix' => '',
            'prefix_indexes' => true,
            'search_path' => 'public',
